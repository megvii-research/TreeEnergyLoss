...
static PyMethodDef __pyx_mdef_3lib_7metrics_10cityscapes_10evaluation_20addToConfusionMatrix_1cEvaluatePair = {"cEvaluatePair", (PyCFunction)__pyx_pw_3lib_7metrics_10cityscapes_10evaluation_20addToConfusionMatrix_1cEvaluatePair, METH_VARARGS|METH_KEYWORDS, 0};
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init lib.metrics.cityscapes.evaluation.addToConfusionMatrix", 0, __pyx_lineno, __pyx_filename);
    }
