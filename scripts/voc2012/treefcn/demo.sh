...
CONFIGS="configs/voc2012/R_101_D_32.json"
...
if [ "$1"x == "val"x ]; then
  ...
  cd lib/metrics
  python3 -u pascal_context_evaluator.py --configs /data/liangzhiyuan/projects/openseg2/configs/voc2012/R_101_D_32.json --pred_dir ${SAVE_DIR}${CHECKPOINTS_NAME}_val/label  \
